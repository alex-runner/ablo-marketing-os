...
FUNNEL = OrderedDict([
    ...
    ("stages", [
        ...
        {"key": "project",  "label": "Created a photoshoot project", "sub": "photoshoot_project_created", "group": "Photoshoot", "counts": W(2, 20)},
        {"key": "photoshoot","label": "Shot a photo",     "sub": "photoshoot_completed","group": "Photoshoot","counts": W(2, 18)},
    ...
    ("spine", {
        ...
        "note": "Same user, of everyone who signed up (since launch): the share who ever reached each milestone. The Step 4 photoshoot is split into creating a project and then shooting a photo (generating an image). Shooting a photo can exceed creating a project because single-shot photoshoots skip the project step, so the bar may tick up there.",
        "denominator": 64,
        "steps": [
            ...
            {"label": "Created a photoshoot project", "count": 20, "pct": 31},
            {"label": "Shot a photo",                 "count": 18, "pct": 28},
